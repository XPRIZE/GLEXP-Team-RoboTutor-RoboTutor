...
public class CAsm_LetterBoxLayout extends LinearLayout {
    ...
    public CAsm_LetterBoxLayout(Context context) {
        super(context);
        init(context, null);
    }

    public CAsm_LetterBoxLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, null);
    }

    public CAsm_LetterBoxLayout(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public void configureBounds() {
        ...
        int dwidth  = ASM_CONST.DESIGNWIDTH;
        int dheight = ASM_CONST.DESIGNHEIGHT;
    ...
    @Override protected void onMeasure (int widthMeasureSpec, int heightMeasureSpec) {
        ...
        setMeasuredDimension(ASM_CONST.DESIGNWIDTH, ASM_CONST.DESIGNHEIGHT);
    }
