 ...
 */
public class CAr_Alley extends LinearLayout {

    private EditText num;
    private DotBag   dotBag;

    float scale = getResources().getDisplayMetrics().density;
    final int textSize = (int)(AR_CONST.textSize*scale);
    final int rightPadding = (int)(AR_CONST.rightPadding*scale);

    static final String TAG = "Alley";

    public CAr_Alley(Context context) {
    ...
    public CAr_Alley(Context context, AttributeSet attrs) {
    ...
    public CAr_Alley(Context context, AttributeSet attrs, int defStyle) {
