...
public class CSceneRelativeLayout extends RelativeLayout implements ITutorSceneImpl {
    ...
    public CSceneRelativeLayout(Context context) {
        super(context);

        init(context, null);
    }

    public CSceneRelativeLayout(Context context, AttributeSet attrs) {
        super(context, attrs);

        init(context, attrs);
    }

    public CSceneRelativeLayout(Context context, AttributeSet attrs, int defStyleAttr) {
