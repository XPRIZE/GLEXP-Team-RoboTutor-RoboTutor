...
public class CSceneFrameLayout extends FrameLayout implements ITutorSceneImpl {
    ...
    public CSceneFrameLayout(Context context) {
        super(context);

        init(context, null);
    }

    public CSceneFrameLayout(Context context, AttributeSet attrs) {
        super(context, attrs);

        init(context, attrs);
    }

    public CSceneFrameLayout(Context context, AttributeSet attrs, int defStyleAttr) {
