...
import cmu.xprize.comp_writing.CResponseScrollController;
...
public class TResponseScrollController extends CResponseScrollController implements ITutorObjectImpl {

    private CTutor mTutor;
    private CObjectDelegate mSceneObject;


    private static final String  TAG = TResponseScrollController.class.getSimpleName();


    public TResponseScrollController(Context context) {
        super(context);
    }

    public TResponseScrollController(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public TResponseScrollController(Context context, AttributeSet attrs, int defStyleAttr) {
