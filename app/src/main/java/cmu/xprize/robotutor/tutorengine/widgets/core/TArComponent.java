...
import cmu.xprize.ar_component.CAr_Component;
import cmu.xprize.ar_component.CAr_Data;
...
public class TArComponent extends CAr_Component implements ITutorObjectImpl {
    ...
    public TArComponent(Context context) {
        super(context);
    }

    public TArComponent(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public TArComponent(Context context, AttributeSet attrs, int defStyleAttr) {
