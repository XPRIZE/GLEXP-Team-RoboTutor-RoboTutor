...
import cmu.xprize.comp_writing.CWritingScrollController;
...
public class TWritingScrollController extends CWritingScrollController  implements ITutorObjectImpl {

    private CTutor mTutor;
    private CObjectDelegate mSceneObject;


    private static final String  TAG = TWritingScrollController.class.getSimpleName();


    public TWritingScrollController(Context context) {
        super(context);
    }

    public TWritingScrollController(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public TWritingScrollController(Context context, AttributeSet attrs, int defStyleAttr) {
