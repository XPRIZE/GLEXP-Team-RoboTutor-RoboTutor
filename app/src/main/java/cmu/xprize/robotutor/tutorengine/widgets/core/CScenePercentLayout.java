...
public class CScenePercentLayout extends PercentRelativeLayout implements ITutorSceneImpl {
    ...
    public CScenePercentLayout(Context context) {
        super(context);

        init(context, null);
    }

    public CScenePercentLayout(Context context, AttributeSet attrs) {
        super(context, attrs);

        init(context, attrs);
    }

    public CScenePercentLayout(Context context, AttributeSet attrs, int defStyleAttr) {
