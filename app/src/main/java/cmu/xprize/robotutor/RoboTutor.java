...
public class RoboTutor extends Activity implements IReadyListener, IRoboTutor {
    ...
    private static final String debugTutorId = "math:100..800.SUB-10-V-S.decr.16";
    private static final String debugTutorFile = "[file]math_100..800.SUB-10-V-S.decr.16.json";//"[file]math_0..8.ADD-1-V-S.incr.1.json";
