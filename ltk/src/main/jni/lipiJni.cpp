...
void JNICALL Java_lipitk_LipiTKJNIInterface_initializeNative(JNIEnv *env,
																 jobject this_object,
...
jobjectArray 
	JNICALL Java_lipitk_LipiTKJNIInterface_recognizeNative(JNIEnv *env,
															   jobject this_object,
															   ...
															   jint NumStrokes)
{
	...
	try
	{
		jclass strokeClass = env->FindClass("lipitk/Stroke");
		if(strokeClass == NULL) {
		...
		jclass resultClass = env->FindClass("lipitk/RecResult");
